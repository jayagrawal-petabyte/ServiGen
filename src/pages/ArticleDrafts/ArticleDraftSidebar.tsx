...
interface ArticleDraftSidebarProps {
  activeView: ArticleDraftView;
  onSelectView: (view: ArticleDraftView) => void;
  searchQuery: string;
...
export default function ArticleDraftSidebar({
  ...
  return (
    <aside className="article-drafts-subnav">
      ...
      <button
        type="button"
        className={`subnav-all-drafts-btn ${
      ...
      <div className="subnav-menu-list">
        <button
          type="button"
          className={`subnav-menu-item ${
            activeView === 'my-lists' ? 'active' : ''
          }`}
