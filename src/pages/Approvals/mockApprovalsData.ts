...
export const INITIAL_APPROVALS: Approval[] = [
  {
    ...
    title:
      'Requesting a bulk mailroom pickup of outgoing packages from the second floor',
    timeAgo: '48 days ago',
    createdAt: '2026-08-07T14:32:00Z',
    description:
      "We have around fifteen parcels ready to go out that won't fit in the usual mailbox collection. Would appreciate a pickup at some point this week rather than carrying them down ourselves.",
    status: 'pending',
    priority: 'Normal',
...

  {
    ...
    description:
      "This was created for the article titled 'Resolving Leave Request Issues'",
    status: 'pending',
    priority: 'High',
    category: 'HR Systems',
    urgency: 'High',
    ticketDetails: {
      ...
      extraInfo:
        'Article Draft ID: 0003026 - Awaiting Manager Approval',
    },
  },

  {
    ...
    description:
      'Hardware, email setup, and security access provisioning required for new hire onboarding in Human Resources.',
    status: 'pending',
    priority: 'High',
...

  {
    ...
    description:
      'Temporary 48-hour access extension needed for database migration telemetry verification on cluster eu-west-1.',
    status: 'pending',
    priority: 'Critical',
